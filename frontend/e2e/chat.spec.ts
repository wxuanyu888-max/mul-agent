...
test.describe('Chat Functionality', () => {
  ...
  test('should send a message and display it', async ({ page }) => {
    ...
    const userMessage = page.locator('div.flex.flex-row-reverse').filter({ hasText: 'Test message' });
  ...
  test('should display API error when backend is unavailable', async ({ page }) => {
    ...
    const assistantMessage = page.locator('div.bg-white').filter({ hasText: /Test message/ }).last();
